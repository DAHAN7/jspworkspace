...
<body>
	<!-- 
		encType - POST 로 전송되는 데이터의 인코딩 설정
	 ...
	 -->
	<form enctype="text/plain" action="requestResult.jsp" method="POST">
		이름 : <input type="text" name="name" /> <br /> 성별 : <input
			...
			type="checkbox" name="hobbies" value="축구" /> 축구 <input
			type="checkbox" name="hobbies" value="database" /> database <input
			type="checkbox" name="hobbies" value="자바" /> 자바 <input
			type="checkbox" name="hobbies" value="여행" /> 여행 <br /> <input
			type="submit" />
	</form>
</body>
</html>