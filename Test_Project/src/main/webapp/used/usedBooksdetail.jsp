...
<body>
    ...
    <sql:query var="bookDetail" dataSource="jdbc/MySQLDB">
        SELECT b.title, b.author, b.publisher, b.price, b.book_fileName as image_path, b.book_memo as description, b.category_all as category, b.stock, b.new_old_ebook as status
        FROM books b
        WHERE b.book_id = ?
